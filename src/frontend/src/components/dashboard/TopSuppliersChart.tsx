...
import { REVENUE_K_DIVISOR, CHART_PRIMARY_COLOR } from '../../constants'
...
export function TopSuppliersChart({ data }: Props) {
  ...
  const revenues = data.map((d) => Math.round(d.total_revenue / REVENUE_K_DIVISOR))
    ...
    <Card>
      <CardContent>
        ...
        <BarChart
          ...
          series={[{ data: revenues, color: CHART_PRIMARY_COLOR }]}
          height={340}
